    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-300 dark:border-gray-700/50 bg-white dark:bg-[#111113]">
      <div className="container mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 md:px-6">
        ...
        <Link to="/MenuPrincipal" className="flex items-center gap-2 z-50">
          ...
          <span className="font-bold text-black dark:text-white sm:inline-block">
            IntelliNote
          </span>
        </Link>
            ...
            <div className="relative">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full 
                           ...
                           hover:text-white hover:bg-gray-600 transition-colors cursor-pointer"
              >
                        ...
                        {user && (
                            <div className="space-y-3">
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Logado como: <span className="font-bold text-gray-900 dark:text-white">{user.name}</span>
                                </p>
                                
                                <button
                                    onClick={handleLogout}
                                    className="flex w-full items-center justify-center gap-2 rounded-md bg-red-900/90 px-4 py-3 text-sm font-medium text-white hover:bg-red-800 transition-colors"
                                >
